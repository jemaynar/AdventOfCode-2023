    ...
    module Part2 =
        ...
        let parseDigitsWithStringPositionTestCases =
            seq {
                ...
                yield [| { Input = "0"; Expected = None } |];
                yield [| { Input = "a0"; Expected = None } |];
                ...
                yield [| { Input = "a3o4a"; Expected = Some([| { Position = 1; Value = Some(3uy) }; { Position = 3; Value = Some(4uy) }; |] |> Array.toSeq) } |];
            }
